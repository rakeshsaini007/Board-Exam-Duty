  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-10 text-center">
        ...
        <p className="mt-3 text-lg text-gray-600">Fetch, Edit and Monitor Duty Assignments</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <Dashboard 
            teachers={teachers} 
            centres={centres} 
            highlightCentre={selectedTeacher?.examinationCentre}
          />
          ...
          <div className="mt-8 bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <ul className="text-gray-600 text-sm space-y-3">
              <li className="flex items-start">
                ...
                Lookup teacher by unique code.
              </li>
              <li className="flex items-start">
                <span className="text-indigo-500 font-bold mr-2">2.</span>
                Choose a new centre from the dropdown.
              </li>
              <li className="flex items-start">
                <span className="text-indigo-500 font-bold mr-2">3.</span>
                Monitor gender stats in "Available Duty" card.
              </li>
            </ul>
          </div>
        </div>
